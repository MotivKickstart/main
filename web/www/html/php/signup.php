...
$sql = "INSERT INTO user (role_id, username, pass, phone, email) VALUES ((SELECT id FROM role WHERE name='user'), ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->execute([$user, $pass, $phone, $email]);
$_SESSION['status1'] = $Resultsstmt->errorInfo();
$_SESSION['status2'] = $Resultsstmt->fetch();
